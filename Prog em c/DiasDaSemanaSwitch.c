...
void main(){
    ...
    N = i*N * (1+i);
    printf("N = %.2f",N);
    printf("\n\nA) Ele conseguirá ter uma parcela nesse valor com essas condições de");
    printf("\nfinanciamento?\nSe sim, em quanto tempo ele pagará o financiamento?");
    printf("\n");
    if(JUROS_C>1500){

        printf("\nR: Sim, ele vai conseguir em um total de %.2f meses", N);
        printf("\n\nB) Qual o valor mínimo da parcela a ser  paga por Carlos com essas condições de"); printf("\nfinanciamento?");
        printf("\n\nR: %.2f R$", JUROS_C);
